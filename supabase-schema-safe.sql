-- 🏥 ESQUEMA DE BASE DE DATOS PARA SISTEMA MÉDICO (VERSIÓN SEGURA)
...
-- 🔄 TRIGGERS PARA ACTUALIZAR updated_at (con manejo de errores)
DO $$ 
BEGIN
...
DROP POLICY IF EXISTS "Allow all operations on smart_flow_data" ON smart_flow_data;
DROP POLICY IF EXISTS "Allow all operations on system_stats" ON system_stats;
